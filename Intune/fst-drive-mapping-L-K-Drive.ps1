...
$driveMappingJson = '[{"Path":"\\\\fst-srv-fs1.ou.ad3.ucdavis.edu\\fst_labs","DriveLetter":"L","Label":"FST_Labs","Id":1,"GroupFilter":"CAES-BFTV-FST-MG-Lab-All, CAES-BFTV-FST-MG-Auto-Faculty"},{"Path":"\\\\fst-srv-fs1.ou.ad3.ucdavis.edu\\fst_faculty","DriveLetter":"K","Label":"FST_Faculty","Id":2,"GroupFilter":"CAES-BFTV-FST-MG-Auto-Faculty"}]'
