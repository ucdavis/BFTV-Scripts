...
Start-Transcript -Path $(Join-Path $env:temp "AGDT-DriveMapping.log")

###########################################################################################
# Input values from generator
###########################################################################################

$driveMappingJson = '[{"Path":"\\\\bftv-srv-fs1.ou.ad3.ucdavis.edu\\Office","DriveLetter":"O","Label":"Office Share","Id":1,"GroupFilter":"CAES-BFTV-MG-Staff, CAES-BFTV-MG-StudentAsst"},{"Path":"\\\\bftv-srv-fs1.ou.ad3.ucdavis.edu\\Install","DriveLetter":"I","Label":"Install","Id":2,"GroupFilter":"CAES-BFTV-MG-Staff-IT"},{"Path":"\\\\bftv-srv-fs1.ou.ad3.ucdavis.edu\\Tech","DriveLetter":"T","Label":"Tech","Id":3,"GroupFilter":"CAES-BFTV-MG-Staff-IT"}]'
